...
export default async function PlatformOverview() {
  ...
  const [restaurants, totalOrdersToday, revenueToday, allOrdersCount] = await Promise.all([
    ...
    <div className="px-4 sm:px-6 lg:px-10 py-8">
      <div className="flex items-end justify-between gap-4 flex-wrap mb-8">
        <div>
          ...
          <p className="text-sm text-surface-500 mt-1">
            Your client restaurants, at a glance.
          </p>
        </div>
        <Link
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          <h2 className="font-display text-xl text-surface-900">All restaurants</h2>
        ...
        {restaurants.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-surface-300 bg-white/60 p-12 text-center">
            <div className="font-display text-2xl text-surface-900">No restaurants yet</div>
